...
const Contact = () => {
  ...
  <div className="h-[90vh] lg:h-[80vh]">
    ...
    <div className="container mx-auto w-full h-full mb-5 sm:mb-0">
      <div className="w-full h-full flex flex-col justify-center md:justify-center items-center mb-10 sm:mb-0">
        {/* Title Content */}
