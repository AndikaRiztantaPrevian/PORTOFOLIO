  ...
  return (
    <div className="flex justify-center items-start gap-4 w-full h-2/4" data-aos="fade-out" data-aos-duration="2000" data-aos-offset="200">
        ...
        <div class="border border-blue-300 shadow rounded-md p-4 w-80 h-auto">
            <div class="py-1 h-full flex flex-col justify-between space-y-4">
                <div class="text-xl tracking-wider underline underline-offset-8 select-none">Pomodoro</div>
                ...
                <div class="flex h-10">
                    <div className="flex items-end w-2/4 cursor-pointer">
